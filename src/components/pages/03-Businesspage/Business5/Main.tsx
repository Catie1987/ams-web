    ...
    <div className='w-full min-h-screen'>
        ...
        <div className='flex w-full md:flex-row flex-col-reverse mt-10 z-10'>
            ...
            <div className='relative w-auto flex'>
                <Image alt='electronicindustry' src={img} height={600} width={800} className='w-full h-full max-w-[800px] max-h-[600] opacity-60 select-none'/>
                <a href='#subcategory' className='absolute flex justify-center items-center left-[8%] top-[77%] sm:top-[75%] h-[2%] w-[2%] hover:cursor-pointer'
                ...
                <a href='#subcategory' className='absolute flex justify-center items-center left-[40%] top-[42%] sm:top-[40%] h-[2%] w-[2%] hover:cursor-pointer'
                ...
                onClick={() => {setClickedIndex(1); setHoverIndex(1)}}>
                    ...
                    {clickedIndex === 1  && <div className='h-[600px] w-[2px] bg-[--cta2] top-2 absolute -z-10 md:block hidden'></div> }
                </a>
                <a href='#subcategory' className='absolute flex justify-center items-center left-[50%] top-[82%] sm:top-[80%] h-[2%] w-[2%] hover:cursor-pointer'
                ...
                <a href='#subcategory' className='absolute flex justify-center items-center left-[62%] top-[36%] sm:top-[34%] h-[2%] w-[2%] hover:cursor-pointer'
                ...
                <a href='#subcategory' className='absolute flex justify-center items-center left-[72%] top-[56%] sm:top-[54%] h-[2%] w-[2%] hover:cursor-pointer'
                ...
                <a href='#subcategory' className='absolute flex justify-center items-center left-[86%] top-[80%] sm:top-[78%] h-[2%] w-[2%] hover:cursor-pointer'
