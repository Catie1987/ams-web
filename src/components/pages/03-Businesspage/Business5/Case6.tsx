...
import img1 from '/public/assets/business5/game1.jpg';
import img2 from '/public/assets/business5/game2.jpg';
import {
  Carousel,
  CarouselContent,
  CarouselDots,
...
export default function Case6() {
  ...
  const items: React.JSX.Element[] = [
    ...
    (
      ...
      <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
        <div className='basis-1/2 max-h-[400px] flex items-center select-none cursor-grab active:cursor-grabbing overflow-hidden'>
        <Image alt={t('cat6b')} src={img2} width={600} height={400} className='object-cover w-auto h-auto'/>
        </div>
        <ul className='basis-1/2 w-full flex flex-col list-none list-outside gap-4'>
          <li className='w-full'>
            <div className='flex gap-2 items-center'>
