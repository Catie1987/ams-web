...
import img1 from '/public/assets/business5/media1.jpg';
import img2 from '/public/assets/business5/media2.webp';
import {
  Carousel,
  CarouselContent,
  CarouselDots,
  ...
  const items: React.JSX.Element[] = [
    (
      ...
      <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
        ...
        <Image alt={t('cat1a')} src={img1} width={600} height={400} className='object-cover w-auto h-auto'/>
        </div>
    ...
    (
      ...
      <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
        ...
        <Image alt={t('cat1b')} src={img2} width={600} height={400} className='object-cover w-auto h-[400px]'/>
        </div>
        <ul className='basis-1/2 w-full flex flex-col list-none list-outside gap-4'>
          <li className='w-full'>
            <div className='flex gap-2 items-center'>
