...
import img from '../../../../../public/assets/business1/key_automotive.png'
    ...
    <div className='w-full min-h-screen'>
        ...
        <div className='flex w-full md:flex-row flex-col-reverse mt-10 z-10'>
            ...
            <div className='relative w-auto flex'>
                <Image alt='' src={img} height={600} width={800} className='w-full h-full max-w-[800px] max-h-[600] opacity-60 select-none'/>
                <a href='#subcategory' className='absolute flex justify-center items-center left-[26%] top-[61%] sm:top-[58%] h-[2%] w-[2%] hover:cursor-pointer'
                ...
                <a href='#subcategory' className='absolute flex justify-center items-center left-[42%] top-[43%] sm:top-[41%] h-[2%] w-[2%] hover:cursor-pointer'
                ...
                onClick={() => {setClickedIndex(1); setHoverIndex(1)}}>
                    ...
                    {clickedIndex === 1  && <div className='h-[680px] w-[2px] bg-[--cta2] top-2 absolute -z-10 md:block hidden'></div> }
                </a>
                ...
                <a href='#subcategory' className='absolute flex justify-center items-center left-[46%] top-[34%] sm:top-[32%] h-[2%] w-[2%] hover:cursor-pointer'
                ...
                onClick={() => {setClickedIndex(3); setHoverIndex(3)}}>
                    ...
                    {clickedIndex === 3  && <div className='h-[800px] w-[2px] bg-[--cta2] top-2 absolute -z-10 md:block hidden'></div> }
                </a>
                ...
                onClick={() => {setClickedIndex(4); setHoverIndex(4)}}>
                    ...
                    {clickedIndex === 4  && <div className='h-[700px] w-[2px] bg-[--cta2] top-2 absolute -z-10 md:block hidden'></div> }
                </a>
            </div>
        </div>
