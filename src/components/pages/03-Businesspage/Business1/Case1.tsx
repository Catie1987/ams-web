...
const items: React.JSX.Element[] = [
  (
    <>
    <Title className='text-[--cta2] text-xl md:text-2xl'>{t('ecu')}</Title>
    <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
      ...
      <Image alt={t('ecu')} src={ecuimg} width={600} height={400} className='object-cover w-auto h-auto'/>
      </div>
  ...
  (
    <>
    <Title className='text-[--cta2] text-xl md:text-2xl'>{t('pcb_ecu')}</Title>
    <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
      <div className='basis-1/2 flex items-center select-none cursor-grab active:cursor-grabbing'>
      <Image alt={t('ecu')} src={pcbecuimg} width={600} height={400} className='object-cover w-auto h-[400px]'/>
      </div>
      <ul className='basis-1/2 w-full flex flex-col list-none list-outside gap-4'>
        <li className='w-full'>
          <div className='flex gap-2 items-center'>
  ...
  (
    <>
      <Title className='text-[--cta2] text-xl md:text-2xl'>{t('fan')}</Title>
      <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
        <div className='basis-1/2 flex items-center max-h-[400px] justify-center select-none cursor-grab active:cursor-grabbing'>
        <Image alt={t('ecu')} src={fanimg} width={600} height={400} className='object-cover w-auto h-auto'/>
        </div>
        <ul className='basis-1/2 w-full flex flex-col list-none list-outside gap-4'>
        <li className='w-full'>
          <div className='flex gap-2 items-center'>
            <div className='h-2 w-2 bg-[--cta2]'></div>
            <p className='text-[--cta2] font-semibold md:text-lg text-base'>{t('lubrication')}</p>
          </div>
          <div className='ml-5'>
            <div className='flex flex-wrap gap-x-2 items-center'>
              <Link href={'/product'} className='hover:underline underline-offset-2 font-medium'>KF-965</Link>
              <span className='text-sm mt-[1px]'>{t('kf965')}</span>
            </div>
            <div className='flex flex-wrap gap-x-2 items-center'>
              <Link href={'/product'} className='hover:underline underline-offset-2 font-medium'>KE-1875</Link>
              <span className='text-sm mt-[1px]'>{t('ke1875')}</span>
  ...
  (
    <>
      <Title className='text-[--cta2] text-xl md:text-2xl'>{t('radiator')}</Title>
      <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
        <div className='basis-1/2 flex items-center max-h-[400px] justify-center select-none cursor-grab active:cursor-grabbing'>
        <Image alt={t('ecu')} src={radiatorimg} width={600} height={400} className='object-cover w-auto h-auto'/>
        </div>
        <ul className='basis-1/2 w-full flex flex-col list-none list-outside gap-4'>
        <li className='w-full'>
          <div className='flex gap-2 items-center'>
