...
import img1 from '/public/assets/business6/internal1.webp';
...
export default function Case3() {
  ...
  const items: React.JSX.Element[] = [
    (
      <>
      <Title className='text-[--cta2] text-xl md:text-2xl'>{t('cat3a')}</Title>
      <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
        ...
        <Image alt={t('cat3a')} src={img1} width={600} height={400} className='object-cover w-auto h-auto'/>
        </div>
    ...
    (
      <>
      <Title className='text-[--cta2] text-xl md:text-2xl'>{t('cat3b')}</Title>
      <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
        <div className='basis-1/2 flex items-center select-none cursor-grab active:cursor-grabbing'>
        <Image alt={t('cat3b')} src={img2} width={600} height={400} className='object-cover w-auto h-[400px]'/>
        </div>
        <ul className='basis-1/2 w-full flex flex-col list-none list-outside gap-4'>
          <li className='w-full'>
            <div className='flex gap-2 items-center'>
    ...
    (
      <>
      <Title className='text-[--cta2] text-xl md:text-2xl'>{t('cat3c')}</Title>
      <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
        <div className='basis-1/2 flex items-center select-none cursor-grab active:cursor-grabbing'>
        <Image alt={t('cat3c')} src={img3} width={600} height={400} className='object-cover w-full h-auto'/>
        </div>
        <ul className='basis-1/2 w-full flex flex-col list-none list-outside gap-4'>
          <li className='w-full'>
            <div className='flex gap-2 items-center'>
    ...
    (
      <>
      <Title className='text-[--cta2] text-xl md:text-2xl'>{t('cat3d')}</Title>
      <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
        <div className='basis-1/2 flex items-center select-none cursor-grab active:cursor-grabbing'>
        <Image alt={t('cat3d')} src={img4} width={600} height={400} className='object-cover w-full h-auto'/>
        </div>
        <ul className='basis-1/2 w-full flex flex-col list-none list-outside gap-4'>
          <li className='w-full'>
            <div className='flex gap-2 items-center'>
    ...
    (
      <>
      <Title className='text-[--cta2] text-xl md:text-2xl'>{t('cat3e')}</Title>
      <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
        <div className='basis-1/2 flex items-center select-none cursor-grab active:cursor-grabbing'>
        <Image alt={t('cat3e')} src={img5} width={600} height={400} className='object-cover w-full h-[400px]'/>
        </div>
        <ul className='basis-1/2 w-full flex flex-col list-none list-outside gap-4'>
          <li className='w-full'>
            <div className='flex gap-2 items-center'>
