...
import img from '../../../../../public/assets/business6/medical1.png'
    ...
    <div className='w-full min-h-screen'>
        ...
        <div className='flex w-full md:flex-row flex-col-reverse mt-10 z-10'>
            ...
            <div className='relative w-auto flex'>
                ...
                <a href='#subcategory' className='absolute flex justify-center items-center left-[12%] top-[40%] sm:top-[40%] h-[2%] w-[2%] hover:cursor-pointer'
                ...
                <a href='#subcategory' className='absolute flex justify-center items-center left-[40%] top-[22%] sm:top-[22%] h-[2%] w-[2%] hover:cursor-pointer'
                ...
                <a href='#subcategory' className='absolute flex justify-center items-center left-[50%] top-[60%] sm:top-[60%] h-[2%] w-[2%] hover:cursor-pointer'
