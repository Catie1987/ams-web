...
import img from '../../../../../public/assets/business8/construction.png'
...
export default function Business8() {
    const t = useTranslations('BusinessPage.construction');
    ...
    <div className='w-full min-h-screen'>
        ...
        <div className='flex w-full md:flex-row flex-col-reverse mt-10 z-10'>
            ...
            <div className='relative w-auto flex'>
                <Image alt='construction' src={img} height={600} width={800} className='w-full h-full max-w-[800px] max-h-[600] opacity-60 select-none'/>
                <a href='#subcategory' className='absolute flex justify-center items-center left-[20%] top-[50%] h-[2%] w-[2%] hover:cursor-pointer'
                ...
                onClick={() => {setClickedIndex(0); setHoverIndex(0)}}>
                    ...
                    {clickedIndex === 0  && <div className='h-[500px] w-[2px] bg-[--cta2] top-2 absolute -z-10 md:block hidden'></div> }
                </a>
                <a href='#subcategory' className='absolute flex justify-center items-center left-[40%] top-[30%] h-[2%] w-[2%] hover:cursor-pointer'
                ...
                <a href='#subcategory' className='absolute flex justify-center items-center left-[44%] top-[50%] h-[2%] w-[2%] hover:cursor-pointer'
