...
import img1 from '/public/assets/business8/other1.jpg';
import img2 from '/public/assets/business8/other2.webp';
import {
  Carousel,
  CarouselContent,
  CarouselDots,
  ...
  const items: React.JSX.Element[] = [
    (
      ...
      <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
        ...
        <Image alt={t('cat3a')} src={img1} width={600} height={400} className='object-cover w-auto h-[400px]'/>
        </div>
