...
import img1 from '../../../../../public/assets/business8/cabin1.webp';
import img2 from '../../../../../public/assets/business8/cabin2.png';
import img3 from '../../../../../public/assets/business8/cabin3.webp';
import {
  Carousel,
  CarouselContent,
  CarouselDots,
...
export default function Case2() {
  ...
  const items: React.JSX.Element[] = [
    ...
    (
      ...
      <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
        <div className='basis-1/2 flex items-center select-none cursor-grab active:cursor-grabbing'>
        <Image alt={t('cat2c')} src={img3} width={600} height={400} className='object-cover max-w-[400px] h-auto'/>
        </div>
        <ul className='basis-1/2 w-full flex flex-col list-none list-outside gap-4'>
          <li className='w-full'>
            <div className='flex gap-2 items-center'>
