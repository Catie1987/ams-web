...
import img1 from '../../../../../public/assets/business7/cable1.webp';
import img2 from '../../../../../public/assets/business7/cable2.jpg';
import img3 from '../../../../../public/assets/business7/cable3.jpg';
import {
  Carousel,
  CarouselContent,
  CarouselDots,
...
export default function Case6() {
  ...
  const items: React.JSX.Element[] = [
    (
      <>
      <Title className='text-[--cta2] text-xl md:text-2xl'>{t('cat6a')}</Title>
      <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
        ...
        <Image alt={t('cat6a')} src={img1} width={600} height={400} className='object-cover w-auto h-auto'/>
        </div>
    ...
    (
      <>
      <Title className='text-[--cta2] text-xl md:text-2xl'>{t('cat6b')}</Title>
      <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
        <div className='basis-1/2 flex items-center select-none cursor-grab active:cursor-grabbing'>
        <Image alt={t('cat6b')} src={img2} width={600} height={400} className='object-cover w-auto h-[400px]'/>
        </div>
        <ul className='basis-1/2 w-full flex flex-col list-none list-outside gap-4'>
          <li className='w-full'>
            <div className='flex gap-2 items-center'>
    ...
    (
        <>
        <Title className='text-[--cta2] text-xl md:text-2xl'>{t('cat6c')}</Title>
        <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
          <div className='basis-1/2 flex items-center select-none cursor-grab active:cursor-grabbing'>
          <Image alt={t('cat6c')} src={img3} width={600} height={400} className='object-cover w-auto h-[400px]'/>
          </div>
          <ul className='basis-1/2 w-full flex flex-col list-none list-outside gap-4'>
            <li className='w-full'>
              <div className='flex gap-2 items-center'>
