...
import img1 from '../../../../../public/assets/business7/power1.jpg';
import img2 from '../../../../../public/assets/business7/power2.avif';
import img3 from '../../../../../public/assets/business7/power3.jpg';
import img4 from '../../../../../public/assets/business7/power4.jpg';
import {
  Carousel,
  CarouselContent,
  CarouselDots,
  ...
  const items: React.JSX.Element[] = [
    ...
    (
      ...
      <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
        ...
        <Image alt={t('cat1b')} src={img2} width={600} height={300} className='object-cover w-auto h-[400px]'/>
        </div>
        <ul className='basis-1/2 w-full flex flex-col list-none list-outside gap-4'>
          <li className='w-full'>
            <div className='flex gap-2 items-center'>
    ...
    (
      <>
      <Title className='text-[--cta2] text-xl md:text-2xl'>{t('cat1d')}</Title>
      <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
        <div className='basis-1/2 w-auto flex items-center select-none cursor-grab active:cursor-grabbing'>
        <Image alt={t('cat1d')} src={img4} width={600} height={600} className='object-cover w-auto h-[400px]'/>
        </div>
        <ul className='basis-1/2 w-full flex flex-col list-none list-outside gap-4'>
          <li className='w-full'>
            <div className='flex gap-2 items-center'>
