...
import img from '/public/assets/business7/battery.png'
...
export default function Business7() {
    const t = useTranslations('BusinessPage.battery');
    const [hoverIndex, setHoverIndex] = useState<number | null>(null);
    const [clickedIndex, setClickedIndex] = useState<number | null>(null);
    const labels = ['button1', 'button2', 'button3', 'button4', 'button5', 'button6'];
  return (
    <div className='w-full min-h-screen'>
        ...
        <div className='flex w-full md:flex-row flex-col-reverse mt-10 z-10'>
            ...
            <div className='relative w-auto flex'>
                <Image alt='medical' src={img} height={600} width={800} className='w-full h-full max-w-[800px] max-h-[600] opacity-60 select-none'/>
                <a href='#subcategory' className='absolute flex justify-center items-center left-[33%] top-[78%] h-[2%] w-[2%] hover:cursor-pointer'
                ...
                <a href='#subcategory' className='absolute flex justify-center items-center left-[40%] top-[89%] h-[2%] w-[2%] hover:cursor-pointer'
                ...
                onClick={() => {setClickedIndex(1); setHoverIndex(1)}}>
                    ...
                    {clickedIndex === 1  && <div className='h-[200px] w-[2px] bg-[--cta2] top-2 absolute -z-10 md:block hidden'></div> }
                </a>
                <a href='#subcategory' className='absolute flex justify-center items-center left-[50%] top-[70%] h-[2%] w-[2%] hover:cursor-pointer'
                ...
                <a href='#subcategory' className='absolute flex justify-center items-center left-[15%] top-[53%] h-[2%] w-[2%] hover:cursor-pointer'
                ...
                onClick={() => {setClickedIndex(3); setHoverIndex(3)}}>
                    ...
                    {clickedIndex === 3  && <div className='h-[600px] w-[2px] bg-[--cta2] top-2 absolute -z-10 md:block hidden'></div> }
                </a>
                <a href='#subcategory' className='absolute flex justify-center items-center left-[60%] top-[20%] h-[2%] w-[2%] hover:cursor-pointer'
                ...
                onClick={() => {setClickedIndex(4); setHoverIndex(4)}}>
                    ...
                    {clickedIndex === 4  && <div className='h-[600px] w-[2px] bg-[--cta2] top-2 absolute -z-10 md:block hidden'></div> }
                </a>
                <a href='#subcategory' className='absolute flex justify-center items-center left-[61%] top-[44%] h-[2%] w-[2%] hover:cursor-pointer'
                onMouseEnter={() => setHoverIndex(5)}
                onMouseLeave={() => hoverIndex !== clickedIndex && setHoverIndex(null)}
                onClick={() => {setClickedIndex(5); setHoverIndex(5)}}>
                    {hoverIndex === 5 || clickedIndex === 5 ? (<PulseAnimate/>): (<div className='absolute h-2 w-2 bg-[--cta2] rounded-full'></div>)}
                    {clickedIndex === 5  && <div className='h-[400px] w-[2px] bg-[--cta2] top-2 absolute -z-10 md:block hidden'></div> }
                </a>
            </div>
        </div>
