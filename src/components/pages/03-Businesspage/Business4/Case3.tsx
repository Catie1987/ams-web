...
export default function Case3() {
  ...
  const items: React.JSX.Element[] = [
    (
      <>
      <Title className='text-[--cta2] text-xl md:text-2xl'>{t('signal')}</Title>
      <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
        ...
        <Image alt={t('signal')} src={img1} width={600} height={400} className='object-cover w-auto h-auto'/>
        </div>
    ...
    (
      <>
      <Title className='text-[--cta2] text-xl md:text-2xl'>{t('power')}</Title>
      <div className='mt-6 flex md:flex-row flex-col gap-y-4 gap-x-6'>
        <div className='basis-1/2 flex w-auto items-center select-none cursor-grab active:cursor-grabbing'>
        <Image alt={t('power')} src={img2} width={600} height={400} className='object-cover w-full h-auto'/>
        </div>
        <ul className='basis-1/2 w-full flex flex-col list-none list-outside gap-4'>
          <li className='w-full'>
            <div className='flex gap-2 items-center'>
